    ...
    return (
        <div className="min-h-[90vh] mt-24 mx-[8%]">
                    ...
                    bag.map((product, idx) =>
                        <div key={idx} className="py-[30px] flex items-center border-b">
                            <div className="flex items-center w-[60%]">
                                ...
                                <p className='max-w-[504px] text-sm text-secondary ml-[30px]'>{product.name}</p>
                            </div>
                            <div className="flex-1 flex items-center justify-between">
                                <p className='text-sm text-[#222222] font-medium'>${product.price}.00</p>
                                ...
                                <p className='w-24 text-sm text-[#222222] font-medium'>${product.qty * product.price}.00</p>
                            </div>
            ...
            <div className="py-[30px] px-4 flex items-center justify-end border-b">
                ...
                <p className='w-24 text-sm font-medium text-right ml-[9.5%]'>${totalPrice}.00</p>
            </div>
            <div className="py-[30px] px-4 flex items-center justify-end border-b ">
            ...
            <div className="py-[30px] px-4 flex items-center justify-end ">
                ...
                <p className='w-24 text-sm font-medium text-right ml-[11%]'>${totalPrice + totalQty * shipping}.00</p>
            </div>
